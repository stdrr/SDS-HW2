...
```{r}
kmax <- 8
res <- do.simulate(n = n1, M = 100, n.iter = 20, kmax = kmax)
hist(res[["AIC"]], main = "")
```
...
plot(1:length(freq.aic), freq.aic,
     main = "K distribution across M=100 simulations", xlab="k components", ylab="Frequency",
     lty=3, lwd = 3, type = "b", pch = 21, col=gray(.6), xlim = c(1, kmax), ylim = c(1, 100))
lines(1:length(freq.bic), freq.bic,
     lty=3, lwd = 3, type = "b", pch = 21, col=gray(.6))
```
